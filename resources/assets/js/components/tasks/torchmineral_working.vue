    ...
    export default {
        ...
        methods: {
            ...
            updateValues: function(){
                ...
                this.$dispatch('task-changed',this.optionKey,'torchmineral',this.total_days, this.total_labour_price, this.total_supervisor, this.total_materials, this.total_cost_price);
            }
        },
        ready(){
