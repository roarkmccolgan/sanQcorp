<template>
  <div class="p-6 bg-gray-300 min-h-screen flex justify-center items-center">
    <div class="w-full max-w-sm">
      <logo class="border block mx-auto w-full max-w-xs fill-white" height="120" />
      <form class="mt-2 bg-white rounded-lg shadow-lg overflow-hidden" @submit.prevent="submit">
