	...
	<div id="proposal">
		<div id="cover" style="position: relative;">
			<div id="header" style="width: 210mm; height: 40mm; margin: 14.219mm 20mm 10mm 10mm;">
				<img id="logo" src="{{asset('img/proposal/logo.jpg')}}" alt="" style="width: 77mm; height: 27.9mm; display: inline-block; vertical-align: top">
			...
			<div id="info" style="width: 210mm; height: 105mm; margin: 0mm 20mm;">
				<table cellspacing="0" cellpadding="2" style="margin-bottom: 10mm; width: 190mm">
					<tr>
						<td style="text-align: right; width: 30%">Sanika Reference: <strong>{{job.order_number}}</strong></td>
						<td style="text-align: right">Date: <strong>{{ job.created_at | moment "MMMM Do YYYY" }}</strong></td>
					</tr>
				</table>
				<table cellspacing="0" cellpadding="10" style="margin-bottom: 20mm; width: 190mm; vertical-align: top">
					<tr>
						...
						<td style="padding-left: 10pt; padding-bottom: 10pt">
							<template v-for="contact in job.contacts">
			...
			<img src="{{ asset('img/proposal/2540years.jpg') }}" alt="" style="width: 210mm; height: 50mm; margin-top: 10mm;">
		</div>
		<div class="proposal-section">
			<p>Dear {{job.contacts[0].first_name}}</p>
		...
		<div class="proposal-section">
			<template v-if="mainImage.photo!=''">
				<img v-bind:src="'{{url('/')}}/jobmedia/'+job.order_number+'/img/'+mainImage.photo" alt="" align="center" class="sitepic" style="width: 184mm; margin: 10mm auto;">
			</template>
			<template v-if="images.length > 0">
				<strong>Site Images:</strong><br/>
				<template v-for="(imageKey, image) in images">
					<img v-if="image.photo!=''" v-bind:src="'{{url('/')}}/jobmedia/'+job.order_number+'/img/'+image.photo" alt="" class="sitepic">
				</template>
			</template>
		</div>
